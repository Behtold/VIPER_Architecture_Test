...
class LaunchTableView: UITableView, UITableViewDelegate, UITableViewDataSource, LaunchesViewProtocol {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = presenter?.launches[indexPath.row].name
        cell.detailTextLabel?.text = presenter?.launches[indexPath.row].detail
        return cell
    }
